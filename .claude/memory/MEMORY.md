...
- [Namespace pkg fakes an import probe](namespace-package-fakes-import-probe.md) — `import X` passes against an empty ./X/ build dir (PEP 420); probe an attribute
- [Splitting a file surfaces masked lint](splitting-a-file-surfaces-masked-lint.md) — per-file linters find real bugs the monolith hid; triage before suppressing
