...
#   4. Pre-scan empty/missing-input robustness (tests/validate-prescans.sh)
#   5. golem-gate-watch feed snapshot (tests/golem-gate-watch.sh)
#   6. Action pin format (tests/lint-action-pins.sh)
#
