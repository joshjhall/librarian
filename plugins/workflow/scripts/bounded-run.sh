...
#
# ┌──────────────────────────────────────────────────────────────────────────┐
# │ DUPLICATE OF bin/bounded-run.sh — KEEP THE FUNCTION BODIES IDENTICAL.    │
# │ The plugin installs standalone (a user gets plugins/workflow/ without    │
# │ the repo's bin/), so it cannot source the repo-level copy. Editing one   │
# │ without the other is caught by tests/lint-bounded-run-sync.sh.          │
# └──────────────────────────────────────────────────────────────────────────┘
#
