...
command echo "  tmux new-session -d -s golem-$N -c \"$root/$wt\" -e GOLEM_ID=golem-$N \"claude --permission-mode auto '/next-issue $N --auto' ; claude --permission-mode auto '/next-issue-ship --auto'\""
